      ...
      <div class="mt-timeline__message">
        <h5 class="mt-timeline__title">
          ...
          <div class="mt-timeline__info">
            <span class="mt-timeline__floor">{{(totalPage - (currentPage - 1) * 32) - index}}楼</span>&ensp;|&ensp;<span
            class="time-timeline__time">{{message.createTime}}</span>
          </div>
        </h5>
        <div class="mt-timeline__content" v-html="message.content"></div>
        <p class="mt-timeline__position">
          <span
            class="mt-timeline__city">{{message.location}}</span>
        </p>
